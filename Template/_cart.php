...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  if (isset($_POST['wishlist-submit'])) {
    $deletedrecord = $cart->transferData($_POST['item_id']);
  }
}
?>
    ...
    <div class="row">
      <div class="col-sm-8">
        ...
        <?php
          ...
          }, $cart_item); // closing array_map function
        endforeach;
        ?>
      </div>
      <!-- subtotal section-->
        ...
        <div class="sub-total border text-center mt-2">
          ...
          <div class="border-top py-4">
            <h5 class="font-baloo font-size-20">
              ...
              <span class="text-danger">$<span class="text-danger" id="deal-price"><?php echo isset($subTotal) ? $cart->getSum($subTotal) : 0; ?></span>
              </span>
            </h5>
